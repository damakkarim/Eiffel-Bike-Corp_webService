...
public class GustaveUserRepo {
    ...
    static {
        ...
        GustaveUser user1 = new GustaveUser(1L, "siwar","siwar.nj1998@gmail.com", "password123", Role.STUDENT);
        GustaveUser user2 = new GustaveUser(2L, "Bob", "bob@gmail.com", "password456", Role.EMPLOYEE);
